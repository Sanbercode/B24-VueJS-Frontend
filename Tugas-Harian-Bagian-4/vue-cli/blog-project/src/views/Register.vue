        ...
        <v-card class="rounded-lg mt-3 elevation-13">
          ...
          <v-container fluid>
            <v-form ref="form" v-model="valid" lazy-validation class="pa-3">
              <v-text-field v-model="name" filled class="rounded-t-lg"
              ...
              <div class="text-xs-center">
                <v-btn @click.prevent="submit" type="submit" color="#0F3B5F" :disabled="!valid" class="white--text rounded-lg" block>
                  Register
