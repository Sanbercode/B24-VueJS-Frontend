export const MembersComponent = {
            ...
            <tbody>
                <tr v-for="(member, index) in members" :key="member.id">
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-sm btn-success my-1" @click="showMember(member.id)"
                                data-toggle="modal" data-target="#uploadPhotoProfile"><i class="fa fa-upload"></i></button>
                        <button type="button" class="btn btn-sm btn-info" @click="showMember(member.id)" data-toggle="modal"
                        ...
                        <div class="modal fade" id="uploadPhotoProfile" data-backdrop="static" data-keyboard="false"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                        <button type="button" class="btn btn-primary" @click.prevent="uploadPhoto(showedMember.id, files)"
    ...
    methods: {
        ...
        async showMember (id) {
            await this.$store.commit('showMember', id);
        },
        async deleteMember (id) {
            await this.$store.commit('deleteMember', id);
        },
        async uploadPhoto (id, files) {
            await this.$store.commit('uploadPhoto', {id, files});
        },
        editMember (member) {
